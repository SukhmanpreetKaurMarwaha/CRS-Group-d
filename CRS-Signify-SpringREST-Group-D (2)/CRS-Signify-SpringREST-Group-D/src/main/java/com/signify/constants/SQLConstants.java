...
public class SQLConstants {
    ...
    public static final String SEARCH_PASS="public static final String ";
    ...
    public static final String SEARCH_DO_COURSE_PAYMENT="select total_payment from payment where Studentid=?";
    public static final String DO_COURSE_PAYMENT="update payment set Mode_of_payment=?, Status=? where Studentid=?";
    public static final String VIEW_GRADE_CARD="Select Courseid,grade from grade_info where std_id=?";
